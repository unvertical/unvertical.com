...
**Unvertical Spółka z Ograniczoną Odpowiedzialnością** (Unvertical Sp. z o.o.)<br>
ul. Hetmańska 25, 15-727 Białystok, Poland<br>
Entered in the Register of Entrepreneurs of the National Court Register (*Krajowy Rejestr Sądowy*) kept by the District Court in Białystok, XII Commercial Division of the National Court Register, under KRS number **0001249880**<br>
NIP **5423516506** &middot; REGON **545082020** &middot; Share capital: PLN 5,000<br>
*privacy@unvertical.com*

For any matter concerning your personal data — including the exercise of any of your rights described below — please use the email address above.
...
- have inaccurate or incomplete data **rectified** (Art. 16);
- have your data **erased** — the "right to be forgotten" (Art. 17);
- **restrict** processing (Art. 18);
- **object** to processing based on our legitimate interests (Art. 21);
- request **data portability** (Art. 20), where applicable;
- **withdraw consent** at any time, where consent is the legal basis (Art. 7(3)), without affecting the lawfulness of processing carried out before withdrawal;
- **lodge a complaint** with a supervisory authority (Art. 77). In Poland, this is the President of the Personal Data Protection Office (*Prezes Urzędu Ochrony Danych Osobowych*, "**UODO**"), <https://uodo.gov.pl/>.

To exercise any of these rights, write to **privacy@unvertical.com**. We will respond within one month of receiving your request, as required by Article 12(3) GDPR.
...
This website addresses a business audience. We do not knowingly collect personal data from children under the age of 16. If you believe a minor has submitted personal data through this site, please contact us and we will delete it.

## 11. Changes to this policy

We may update this notice from time to time. The "Last updated" date at the top of this page reflects the most recent change. Where a material change affects data we have already collected, we will communicate it separately where feasible.
